    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-md-6 image-wraper">
                <div itemscope=""><img src="src/kebab.jpeg" alt="kebab" title="kebab" itemprop="contentUrl"></div>                <style>
                    .disclaimer{
                        display: block;
                        margin: 20px 0 0;
                        font-size: 12px;
            ...
            <div class="col-sm-6 col-md-6">
                <div class="single-shop-right  col-xs-12">
                    <div class="single-shop-caption">
                         ...
                         Lavaș, carne de pui, cartofi pai, varză, castraveți murați, roșii, sos alb, sos roșu.                    </div>
...
<div id="pg-6" class="object-property-group active">
    ...
    <dl itemprop="itemListElement" itemscope="" itemtype="http://schema.org/NameValueStructure"><dt itemprop="name"></dt><meta itemprop="main" content="True"><dd itemprop="value">400g</dd></dl>
